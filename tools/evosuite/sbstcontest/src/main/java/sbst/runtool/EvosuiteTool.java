...
public class EvosuiteTool implements ITestingTool {
  ...
  public List<File> getExtraClassPath() {
    ...
    List<File> extraCPs = new ArrayList<>();
    extraCPs.add(binFile);
    extraCPs.addAll(classPathList);
    extraCPs.add(evosuiteJarFile);
    return extraCPs;
  }
  ...
  public void run(String cName, long timeBudget) {
    ...
    cmdLine.append(String.format("-Dreport_dir=%s ", junitOutputDirName));
